    ...
    begin
      ...
      if not((addr(self._stateChangeCallback) <> nil)) then
        begin
          ...
          _eventChains_pos := length(self._eventChains);
          SetLength(self._eventChains, _eventChains_pos+7);
          self._eventChains[_eventChains_pos] := self.get_bitChain1;
          inc(_eventChains_pos);
          self._eventChains[_eventChains_pos] := self.get_bitChain2;
          inc(_eventChains_pos);
          self._eventChains[_eventChains_pos] := self.get_bitChain3;
          inc(_eventChains_pos);
          self._eventChains[_eventChains_pos] := self.get_bitChain4;
          inc(_eventChains_pos);
          self._eventChains[_eventChains_pos] := self.get_bitChain5;
          inc(_eventChains_pos);
          self._eventChains[_eventChains_pos] := self.get_bitChain6;
          inc(_eventChains_pos);
          self._eventChains[_eventChains_pos] := self.get_bitChain7;
          inc(_eventChains_pos);
          SetLength(self._eventChains, _eventChains_pos);
          result := YAPI_SUCCESS;
          exit;
        end;
