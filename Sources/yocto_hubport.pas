{*********************************************************************
 *
 * $Id: yocto_hubport.pas 10384 2013-03-16 16:57:45Z martinm $
 *
...
public
  ...
  procedure advertiseValue(value : String);override;
   ...
   /// </summary>
   /// <returns>
   ///   a value among <c>Y_PORTSTATE_OFF</c>, <c>Y_PORTSTATE_ON</c> and <c>Y_PORTSTATE_RUN</c>
...
/// </summary>
/// <returns>
///   a value among Y_PORTSTATE_OFF, Y_PORTSTATE_ON and Y_PORTSTATE_RUN corresponding to the current
///   state of the Yocto-hub port
/// </returns>
/// <para>
