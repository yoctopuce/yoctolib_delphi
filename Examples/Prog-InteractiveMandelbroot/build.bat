...
SET BDS_NS=Winapi;System.Win;Data.Win;Datasnap.Win;Web.Win;Soap.Win;Xml.Win;Bde;System;Xml;Data;Datasnap;Web;Soap;
...
dcc32.exe %BDS_STDOPTS% %BDS_PATHOPTS% InteractiveMandelbroot.dpr
